...
def main():
    ...
    system_prompt = (
        ...
        "Coloque todas as doenças relacionadas possíveis. Faça sempre 10 perguntas muito úteis, nem menos nem mais que isso. Faça também calculos de IMC, caso o usuario pedir e nesse caso só faça perguntas apenas quando o usuario der sintomas."
